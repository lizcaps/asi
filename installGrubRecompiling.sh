...
# -- Grub Recompiling for keyboard mapping support  --
# see https://wiki.archlinux.org/index.php/GRUB/Tips_and_tricks#Manual_configuration_of_core_image_for_early_boot
arch-chroot /mnt grub-kbdcomp -o dvorak.gkb $KEYMAP
arch-chroot /mnt tar cf memdisk.tar $KEYMAP.gkb

# save /boot/grub/grub.cfg in some ways
# get the insmod lines where module are listed. save the result as a single string. done with sed
# get the crypto uuid
# '''
...
# write in a file boot/grub/early-grub.cfg
